...
d = 1#拡散率
drealx = 1 * 0.5#刻み幅
drealt = 0.15 * 0.25#刻み時間

L = 51 * 2#L*Lマス
k1 = 0.001#もうひとつの死滅率（履歴なし）（絶滅率）
k2 = 0.48#境界付近の死滅率0.4～0.2（履歴率）
...
#T(w, L)#2,104
#overdensity(w, L, a, b)
title = "square4"#cross, square4, square, rectangle, interval_square, I, S, T, overdensity
...
while stepcount <= fn:
    ...
    if stepcount == 400 or stepcount == 1400:
