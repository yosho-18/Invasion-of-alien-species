...
plt.show()
#plt.savefig("dist_vani{stp:03}".format(stp=stepcount))
...
plt.ylabel('h position')
#plt.ylim(0, 2)
#plt.ylim(0, 2)
#plt.show()
#plt.savefig("free boundary va{stp:03}".format(stp=stepcount))